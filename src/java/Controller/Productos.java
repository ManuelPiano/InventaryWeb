...
public class Productos extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         String categorianom = request.getParameter("catogoria_nom");
         ...
         if(estado.equals("listar")){
             ...
             RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/Vistas-Productos/editarProductos.jsp?id="+id_pro+"&&nombre="+nombre_pro+"&&estado="+estado_pro+"&&precio="+precio_pro+"&&stock="+stock_pro+"&&UnidadMedida="+unidad_medida+"&&catogoria_nom="+categorianom);
